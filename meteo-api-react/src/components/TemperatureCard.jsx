                ...
                <div className="card h-100">
                    <div className="card-body d-flex flex-column justify-content-center align-items-center text-center">
                        ...
                        <p className="card-text">
                            <div className='media-q-temperature'><img src="imgs/icons8-termometro-giù-50.png" className="icon-3" alt="temp-min" /> <b>min</b> {temp.temp_min.toFixed(1)}° | <b>max</b> {temp.temp_max.toFixed(1)}°  <img className="icon-3" src="imgs/icons8-thermometer-up-50.png" alt="temp-min" /></div>
                        </p>
                    </div>
                </div >
            </div >
